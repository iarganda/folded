...
| ![Example of reference image to be used with the 'folded' script](./images/documentation/Reference-image-example.jpg) | 
|:--:| 
| **Example of reference image to be used with the 'folded' script** |
...
|:--:| 
| **Example of output files generated by the 'folded' script** |
